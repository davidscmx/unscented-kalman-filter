...
public:
    ...
    /**
     * @brief Generates sigma points and augments with the process noise vector
     * 
     * @param Xsig_out 
     */
    ...
    /**
     * @brief Passes the generated sigma points through the (non-linear) prediction function f
     * 
     * @param Xsig_aug 
     * @param dt 
     */
    ...
    /**
     * @brief Predict the mean and the covariants using the weights 
     * 
     */
